...
export default function EmpProfile() {
    ...
    if (token) {
      ...
      axios
        ...
        .then((response) => {
            ...
            setEducationInfo(res.data[1]);
            setWorkExpInfo(res.data[2]);
            setProjectInfo(res.data[3]);
        })
        .catch((error) => {
          alert("First Craete the Profile")
  ...
  const handleUpdatedProfile = (e) => {
    ...
    if (token) {
      ...
      axios
        .patch(`http://localhost:5000/employee/profile`,profiledata,{headers})
        .then((response) => {
          const res = response.data;
  ...
  return (
    <div style={{backgroundColor: "#282a36"}}>
      ...
      <Container className="p-5">
        <h4 className="text-center text-light">Update Profile</h4>
